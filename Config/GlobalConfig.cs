...
public class GlobalConfig {
    ...
    public static readonly string TopicArnFormat = string.Format("arn:aws:sns:us-east-1:796987500533:%s", TopicNamePrefix) + "%d";
    ...
    public static readonly string RECORDER_PATH_FMT = RECORDER_BASE_PATH + "/%d/%d/%s";
